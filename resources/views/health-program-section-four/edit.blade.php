        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card ">
                    ...
                    <div class="card-body">
                        <form action="{{route('health-program-page.health-program-section-four.update', $slider->id)}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input 
                                            ...
                                            id="location" 
                                            name="location"
                                            value="{{ old('location', $slider->location) }}" 
                                            placeholder="Enter location (e.g., Kampala, Uganda)" required>
                                        <div class="help-block with-errors"></div>
                                        @error('location')
                                            <span class="text-red" role="alert">
                                                <strong>{{ $message }}</strong>
                            ...
                            <div class="form-row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input 
                                            ...
                                            name="image"
                                            accept="image/*"
                                            data-default-file="{{ $slider->image ? asset('images/' . $slider->image) : '' }}">
                                        <div class="help-block with-errors"></div>
                                        @error('image')
                                            <span class="text-red" role="alert">
                                                <strong>{{ $message }}</strong>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <img src="{{ asset('images/' . $slider->image) }}" alt="Current Image"
