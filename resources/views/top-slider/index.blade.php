            ...
            <div class="col-md-12">
                <div class="card p-3">
                    <div class="card-header">
                        <h3>@lang('Top Slider')</h3>
                        @can('create')
                            <div class="card-header-right">
                                <a href="{{URL::to('home-page/top-slider/create')}}" class="btn btn-primary">
                                    @lang('Add')
                                </a>
                            </div>
                        @endcan
    ...
    <script type="text/javascript">
        $(document).ready( function () {
            ...
            var dTable = $('#datatable').DataTable({
                ...
                ajax: {
                    url: "{{route('home-page.top-slider.index')}}",
                    type: "get"
                },
                columns: [
                    { data: 'DT_RowIndex', name: 'DT_RowIndex', orderable: false, searchable: false },
                    {data:'slider_image', name: 'slider_image', orderable: true, searchable: true},
        ...
        function deleteItem(id) {
            var url = '{{ route("home-page.top-slider.destroy",":id") }}';
            $.ajax({
                type: "DELETE",
