        ...
        <div class="section-padding">
            <div class="container">
                <div class="content-container">
                        <h1>Who We Are</h1>
                    <p>SAJIDA Foundation is a value-driven, non-government organisation. It embodies the principle of corporate philanthropy, with 51% shareholding of Renata Ltd, one of the fastest growing pharmaceutical and animal health product companies in Bangladesh. The organisation, founded in 1993, aims to empower communities, catalyse entrepreneurship, build equity and establish enterprises for good with an overarching vision of ensuring health, happiness, and dignity for all.</p>
                    <div class="btns">
                            ...
                            <div class="modal-content">
                                <div class="popup-message d-flex">
                                    ...
                                    <div class="popup-content">
                                        ...
                                        <h4>Zahida Fizza Kabir <span>Chief Executive Officer</span></h4>
                                        <p>Ms. Zahida Fizza Kabir has 30+ years of leadership in finance, healthcare, and community development. Since 1993, she has expanded SAJIDA to 400 offices with 6,000 staff. She has established six portfolio companies in mental health, geriatric care, and child development and leads two specialized healthcare enterprises. She also chairs the Psychological Mental Health and Wellness Clinic and serves on the boards of Renata Limited, SAJIDA Uganda, and SAJIDA USA. Ms. Kabir holds degrees from Oxford, Vermont, and the University of the Philippines. </p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="section-padding">
                <div class="container">
                    <div class="content-container">
                        ...
                        <div class="right-side"><p>We drive large-scale transformation by empowering women  and their families to overcome poverty, build resilience, and <br> foster resourcefulness.</p></div>
                    </div>
