        ...
        <div class="section-padding">
            <div class="container">
                ...
                <div class="slider d-flex">
                    ...
                    <div class="single-slider-item" data-bs-toggle="modal" data-bs-target="#myModal-10">
                        <div class="image">
                            <img src="{{ asset('assets/img/images.jpg') }}" alt="">
                        </div>
                        <div class="content">
                            <h4>Dr. Asadur Rahman <span>Head of Health Programmes (BGD)</span></h4>
                        </div>
                    </div>
                    <div class="single-slider-item" data-bs-toggle="modal" data-bs-target="#myModal-11">
                        <div class="image">
                            <img src="{{ asset('assets/img/Dr._Ariful_Haque.webp') }}" alt="">
                        </div>
                        <div class="content">
                            <h4>Dr. Muhammad Ariful Haque <span>Associate Director - Development Programme (BGD)</span></h4>
                        </div>
                    </div>
