    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-between">
            <div class="top-menu d-flex align-items-center">
                ...
                <button type="button" id="navbar-fullscreen" class="nav-link" title="Maximize"><i class="ik ik-maximize"></i></button>&nbsp;&nbsp;
                <button type="button" id="navbar-fullscreen" class="nav-link" title="Visit Site">
            ...
            <div class="top-menu d-flex align-items-center">
                ...
                <button class="btn" title="Profile">
                    <a href="#">
                        {{ auth()->user()->name }}
                    </a>
                </button>
                <div class="dropdown">
                    <a class="dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                        aria-haspopup="true" aria-expanded="false"><img class="avatar"
                            src="{{ asset('assets/images/blue-logo.png') }}" alt=""></a>
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                        <a class="dropdown-item" href="{{ url('profile') }}"><i class="ik ik-user dropdown-icon"></i>
                            {{ __('Profile') }}</a>
                        <a class="dropdown-item" href="#"><i class="ik ik-check dropdown-icon"></i>
                            {{ auth()->user()->name }}</a>
