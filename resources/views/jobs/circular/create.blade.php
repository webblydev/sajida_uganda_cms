            ...
            <div class="col-md-12">
                <div class="card ">
                    <div class="card-header">
                        <h3>{{ __('Add Job Circular') }}</h3>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('job.circular.store') }}" method="POST">
                            @csrf
                            <div class="form-row">
                                <div class="col-sm-4">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="text" class="form-control" id="job_nature" name="job_nature"
                                        placeholder="Enter Job Nature Here" value="{{ old('job_nature') }}" required>
                                    @error('job_nature')
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="text" class="form-control" id="salary_range" name="salary_range"
                                        placeholder="Enter Salary Range" value="{{ old('salary_range') }}" required>
                                    @error('salary_range')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
