...
@section('title', 'Add Approach Article')
@section('content')
            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline hello">
                            <h5>{{ __('Approach Article')}}</h5>
                            <span>{{ __('Add Approach Article')}}</span>
                        </div>
            ...
            <div class="col-md-12">
                <div class="card ">
                    <div class="card-header">
                        <h3>{{ __('Add Approach Article')}}</h3>
                    </div>
                    <div class="card-body">
                        <form action="{{route('home-page.approach-item.store')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-row">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select name="approach_id" id="approach_id" class="form-control select2">
                                            ...
                                            <option value="{{ $approach->id }}"
                                                @if( old('approach_id') == $approach->id )
                                                    selected
                                                @endif
                                                >
                                                {{ $approach->title }}
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="url" name="url" placeholder="Enter External Link Here" value="{{ old('url') }}" required>
                                    @error('url')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
