                ...
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            ...
                            <span>{{ __('Update Designation') }}</span>
                        </div>
            ...
            <div class="col-md-12">
                <div class="card ">
                    <div class="card-header">
                        <h3>{{ __('Update Designation') }}</h3>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('member-designation.update', $memberType->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="title" name="title"
                                        placeholder="Enter Designation Title Here"
                                        value="{{ old('title', optional($memberType)->title) }}">
                                    @error('title')
