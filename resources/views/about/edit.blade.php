                        ...
                        <form action="{{ route('about-us.update', $aboutUs->id) }}" method="POST"
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="title" name="title" placeholder="Enter Title Here" value="{{ old('title', optional($aboutUs)->title) }}" required>
                                    @error('code')
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    @if ($aboutUs && $aboutUs->banner_image)
                                        <img class="mt-3" src="{{ asset('images/' . $aboutUs->banner_image) }}"
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea class="form-control" name="description" id="summernote">{{$aboutUs->description}}</textarea>
                                    @error('code')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
