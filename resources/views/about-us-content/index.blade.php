                    ...
                    <div class="card-header">
                        ...
                        @can('create')
                            <div class="card-header-right">
                                <a href="{{URL::to('about-us-content/create')}}" class="btn btn-primary">
                                    @lang('Add')
                                </a>
                            </div>
                        @endcan
    ...
    <script type="text/javascript">
        $(document).ready( function () {
            ...
            var dTable = $('#datatable').DataTable({
                ...
                ajax: {
                    url: "{{route('about-us-content.index')}}",
                    type: "get"
                },
                columns: [
                    { data: 'DT_RowIndex', name: 'DT_RowIndex', orderable: false, searchable: false },
                    {data:'category', name: 'title', orderable: true, searchable: true},
        ...
        function deleteItem(id) {
            var url = '{{ route("about-us-content.destroy",":id") }}';
            $.ajax({
                type: "DELETE",
