            ...
            <div class="col-md-12">
                <div class="card ">
                    <div class="card-header">
                        <h3>{{ __('Edit District') }}</h3>
                    </div>
                    <div class="card-body">

                        {{-- {{ Form::open(array('route' => 'hrm.designation.store', 'class' => 'forms-sample', 'id'=>'createRank','method'=>'POST')) }} --}}
                        <form action="{{ route('district.update', $district->id) }}" method="post" class="form-group">
                            @csrf
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input id="name" type="text"
                                            ...
                                            value={{ $district->name }} placeholder="">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input id="bn_name" type="text"
                                            class="form-control @error('name') is-invalid @enderror" name="bn_name"
                                            value={{ $district->bn_name }} placeholder="">
                                        <div class="help-block with-errors"></div>
                                        @error('bn_name')
                                            <span class="text-red-error" role="alert">
                                                <strong>{{ $message }}</strong>
