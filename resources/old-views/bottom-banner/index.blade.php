            ...
            <div class="col-md-12">
                <div class="card p-3">
                    <div class="card-header">
                        <h3>@lang('Bottom Banner')</h3>
                        @can('create')
                            <div class="card-header-right">
                                <a href="{{URL::to('home-page/bottom-banner/create')}}" class="btn btn-primary">
                                    @lang('Add')
                                </a>
                            </div>
                        @endcan
    ...
    <script type="text/javascript">
        $(document).ready( function () {
            ...
            var dTable = $('#datatable').DataTable({
                ...
                ajax: {
                    url: "{{route('home-page.bottom-banner.index')}}",
                    type: "get"
                },
                columns: [
                    ...
                    {data:'banner_image', name: 'banner_image', orderable: true, searchable: true},
        ...
        function deleteItem(id) {
            var url = '{{ route("home-page.bottom-banner.destroy",":id") }}';
            $.ajax({
                type: "DELETE",
