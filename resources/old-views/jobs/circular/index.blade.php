    ...
    <script type="text/javascript">
        $(document).ready( function () {
            ...
            var dTable = $('#datatable').DataTable({
                ...
                ajax: {
                    url: "{{route('job.circular.index')}}",
                    type: "get"
                },
                columns: [
                    { data: 'DT_RowIndex', name: 'DT_RowIndex', orderable: false, searchable: false },
                    {data:'job_date', name: 'job_date', orderable: true, searchable: true},
                    {data:'job_nature', name: 'job_nature', orderable: true, searchable: true},
                    {data:'vacancy', name: 'vacancy', orderable: true, searchable: true},
                    {data:'closing_date', name: 'closing_date', orderable: true, searchable: true},
        ...
        function deleteItem(id) {
            var url = '{{ route("job.circular.destroy",":id") }}';
            $.ajax({
                type: "DELETE",
            ...
            // console.log(id);
                ...
                if (changeStatus) {
                    var url = '{{ route("job.circular.status",":id") }}';
                    $.ajax({
                        type: "GET",
                        url: url.replace(':id', id),
                        success:function(resp)
