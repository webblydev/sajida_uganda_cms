            ...
            <div class="col-md-12">
                <div class="card ">
                    <div class="card-header">
                        <h3>{{ __('Edit Fee Type') }}</h3>
                    </div>
                    <div class="card-body">

                        {{-- {{ Form::open(array('route' => 'hrm.designation.store', 'class' => 'forms-sample', 'id'=>'createRank','method'=>'POST')) }} --}}
                        <form action="{{ route('fee_type.update', $fee_type->id) }}" method="post" class="form-group">
                            @csrf
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input id="name" type="text"
                                            ...
                                            value={{ $fee_type->name }} placeholder="">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input id="amount" type="number"
                                            ...
                                            value="{{ $fee_type->amount }}" placeholder="">
                                        <div class="help-block with-errors"></div>
                                        @error('amount')
                                            <span class="text-red-error" role="alert">
                                                <strong>{{ $message }}</strong>
