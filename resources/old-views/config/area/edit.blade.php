            ...
            <div class="col-md-12">
                <div class="card ">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('area.update', $area->id) }}" method="post" class="form-group">
                            @csrf
                            <div class="row">
                                <div class="col-sm-6">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <textarea cols='30' rows='10' id="note" type="text"
                                            class="form-control @error('note') is-invalid @enderror" name="note" placeholder="">{{ $area->note }}</textarea>
                                        <div class="help-block with-errors"></div>
                                        @error('note')
                                            <span class="text-red-error" role="alert">
                                                <strong>{{ $message }}</strong>
