            ...
            <div class="col-md-12">
                <div class="card ">
                    <div class="card-header">
                        <h3>{{ __('Edit Reference') }}</h3>
                    </div>
                    <div class="card-body">

                        {{-- {{ Form::open(array('route' => 'hrm.designation.store', 'class' => 'forms-sample', 'id'=>'createRank','method'=>'POST')) }} --}}
                        <form action="{{ route('reference.update', $reference->id) }}" method="post" class="form-group">
                            @csrf
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input id="name" type="text"
                                            ...
                                            value={{ $reference->name }} placeholder="">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control phone-number-input" id="phone_number"
                                                ...
                                                value="{{ substr($reference->phone_number, 3) }}">
                                        </div>
