            ...
            <div class="col-md-12">
                <div class="card p-3">
                    <div class="card-header">
                        <h3>@lang('Top Banner')</h3>
                        @can('create')
                            <div class="card-header-right">
                                <a href="{{URL::to('top-banner/create')}}" class="btn btn-primary">
                                    @lang('Add')
                                </a>
                            </div>
                        @endcan
...
<script src="{{ asset('plugins/sweetalert/dist/sweetalert.min.js') }}"></script>
    <script type="text/javascript">
        ...
        function deleteItem(id) {
            var url = '{{ route("top-banner.destroy",":id") }}';
            $.ajax({
                type: "DELETE",
