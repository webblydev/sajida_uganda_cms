                    ...
                    <div class="card-header">
                        ...
                        @can('create')
                            <div class="card-header-right">
                                <a href="{{URL::to('home-page/approach/create')}}" class="btn btn-primary">
                                    @lang('Add')
                                </a>
                            </div>
                        @endcan
    ...
    <script type="text/javascript">
        $(document).ready( function () {
            ...
            var dTable = $('#datatable').DataTable({
                ...
                ajax: {
                    url: "{{route('home-page.approach.index')}}",
                    type: "get"
                },
                columns: [
        ...
        function deleteItem(id) {
            var url = '{{ route("home-page.approach.destroy",":id") }}';
            $.ajax({
                type: "DELETE",
        ...
        $('.card-body').on('click', '.changeStatus', function (e) {
            ...
            // console.log(id);
                ...
                if (changeStatus) {
                    var url = '{{ route("home-page.approach.status",":id") }}';
                    $.ajax({
                        type: "GET",
                        url: url.replace(':id', id),
                        success:function(resp)
