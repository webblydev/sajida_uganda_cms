...
@section('title', 'Update News Category')
@section('content')
            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5>{{ __('News') }}</h5>
                            <span>{{ __('Update News Category') }}</span>
                        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card ">
                    ...
                    <div class="card-body">
                        <form action="{{ route('home-page.news-category.update', $newsCategory->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="title" name="title"
                                        ...
                                        value="{{ old('title', optional($newsCategory)->title) }}">
                                    @error('title')
