            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        <i>
                            <img src="{{ asset('sections/home/home-s7.png') }}" alt="" srcset="" style="max-width: 40px; max-height: 50px">
                        </i>
                        <div class="d-inline">
                            <h5>{{ __('HOME PAGE')}}</h5>
                    ...
                    <div class="card-header">
                        ...
                        @can('create')
                            <div class="card-header-right">
                                <a href="{{URL::to('home-page/news-category/create')}}" class="btn btn-primary">
                                    @lang('Add')
                                </a>
                            </div>
                        @endcan
    ...
    <script type="text/javascript">
        $(document).ready( function () {
            ...
            var dTable = $('#datatable').DataTable({
                ...
                ajax: {
                    url: "{{route('home-page.news-category.index')}}",
                    type: "get"
                },
                columns: [
        ...
        function deleteItem(id) {
            var url = '{{ route("home-page.news-category.destroy",":id") }}';
            $.ajax({
                type: "DELETE",
        ...
        $('.card-body').on('click', '.changeStatus', function (e) {
            ...
            // console.log(id);
                ...
                if (changeStatus) {
                    var url = '{{ route("news-category.status",":id") }}';
                    $.ajax({
                        type: "GET",
                        url: url.replace(':id', id),
                        success:function(resp)
